...
const Error500 = () => {
  ...
  return (
    <>
      <NextSeo
        title={t('error-500.title', { siteTitle: t('all:site-title') })}
        canonical={`${settings.main.URL}${router.asPath}`}
        openGraph={{
          url: `${settings.main.URL}${router.asPath}`,
          title: t('error-500.og-title', { siteTitle: t('all:site-title') }),
      ...
      <div className="main">
        <Alert
          title={t('error-500.alert-title')}
          text={t('error-500.alert-text')}
